...
const cardPayments = useCardPaymentStore()
const casinoChips = useCasinoChipStore()
...
function doPrestige(): void {
    ...
    cardPayments.prestigeReset()
    casinoChips.prestigeReset()
    banking.prestigeReset()
    limitOrders.prestigeReset()
